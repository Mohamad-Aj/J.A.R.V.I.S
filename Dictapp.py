...
def closeappweb(query):
    if "one tab" in query or "1 tab" in query or "two tabs" in query or "2 tabs" in query or "three tab" in query or "3 tabs" in query or "four tab" in query or "4 tabs" in query or "all" in query:
